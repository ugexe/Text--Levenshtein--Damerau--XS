# This Makefile is for the Text::Levenshtein::Damerau::XS extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Text/Levenshtein/Damerau/XS.pm]
#     AUTHOR => [q[Nick Logan <ug@skunkds.org>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     LICENSE => q[perl]
#     META_MERGE => { resources=>{ bugtracker=>q[https://rt.cpan.org/Public/Dist/Display.html?Name=Text-Levenshtein-Damerau-XS] } }
...
MAKE = make
FULLEXT = Text/Levenshtein/Damerau/XS
BASEEXT = XS
PARENT_NAME = Text::Levenshtein::Damerau
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Text/Levenshtein/Damerau/XS.pm
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Text/Levenshtein/Damerau/XS.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Text/Levenshtein/Damerau
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Text/Levenshtein/Damerau
...
TO_INST_PM = lib/Text/Levenshtein/Damerau/XS.pm

PM_TO_BLIB = lib/Text/Levenshtein/Damerau/XS.pm \
...
DISTVNAME = Text-Levenshtein-Damerau-XS-1.1
...
# Text::Levenshtein::Damerau::XS might depend on some other libraries:
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Text/Levenshtein/Damerau/XS.pm $(INST_MAN3DIR)/Text::Levenshtein::Damerau::XS.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''XS Damerau Levenshtein edit distance.'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Text-Levenshtein-Damerau-XS' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "XS Damerau Levenshtein edit distance.",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Text-Levenshtein-Damerau-XS",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "web" : "https://rt.cpan.org/Public/Dist/Display.html?Name=Text-Levenshtein-Damerau-XS"' >> META_new.json
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Text/Levenshtein/Damerau/XS.pm blib/lib/Text/Levenshtein/Damerau/XS.pm 
